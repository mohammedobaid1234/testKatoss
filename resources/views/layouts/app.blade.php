...
<head><base href="">
    ...
    <meta name="description" content="CMS admin dashboard live demo. Check out all the features of the admin panel. A large number of settings, additional services and widgets." />
    ...
    {{-- @if(app()->getLocale() == 'ar')
    <link href="{{asset('/assets/plugins/global/fonts/keenthemes-icons/ki.rtl.css')}}" rel="stylesheet" type="text/css" />
...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
    ...
    <div class="d-flex flex-column flex-root">
        ...
        @include('layouts/navigation')
            ...
            <div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
                ...
                <!--end::Header-->
                <!--begin::Content-->
                <div class="content d-flex flex-column flex-column-fluid removeClass" id="kt_content">
                    <!--begin::Subheader-->
                    ...
                    <div class="d-flex flex-column-fluid">
                        ...
                        <div class="container">
                            <!--begin::Dashboard-->
                            <!--begin::Row-->
                            <div class="row p-10 remomveWhenCol " style="background: #fff">
                                @yield('contnet')
                            </div>
                        </div>
                        <!--end::Container-->
                    ...
                    <div class="card-header align-items-center px-4 py-3">
                        ...
                        <div class="text-center flex-grow-1">
                            ...
                            <div>
                                ...
                                <spaglon class="font-weight-bold text-muted font-size-sm">Active</spaglon>
                            </div>
                        </div>
    ...
    <script src="{{ asset('core/js/global.js') }}"></script>
