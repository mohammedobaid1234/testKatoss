...
<head>
  ...
  <!--====== Favicon Icon ======-->
  <link rel="shortcut icon" href="{{('assets_front/images/favicon.svg')}}" type="image/svg" />

  <!--====== Bootstrap css ======-->
  <link rel="stylesheet" href="{{('assets_front/css/bootstrap.min.css')}}" />

  <!--====== Line Icons css ======-->
  <link rel="stylesheet" href="{{('assets_front/css/lineicons.css')}}" />

  <!--====== Tiny Slider css ======-->
  <link rel="stylesheet" href="{{('assets_front/css/tiny-slider.css')}}" />

  <!--====== gLightBox css ======-->
  <link rel="stylesheet" href="{{('assets_front/css/glightbox.min.css')}}" />
...
<body>
        ...
        <div class="col-lg-12">
          <nav class="navbar navbar-expand-lg">
            <a class="navbar-brand" href="index.html">
              <img src="{{('assets_front/images/white-logo.svg')}}" alt="Logo" />
            </a>
      ...
      <div class="row list-news">
        {{-- <div class="col-lg-4 col-md-6 col-12">
          ...
          <div class="single-news">
            <div class="image">
              <a href="javascript:void(0)"><img class="thumb" src="{{('assets_front/images/blog/1.jpg')}}" alt="Blog" /></a>
              <div class="meta-details">
                <img class="thumb" src="{{('assets_front/images/blog/b6.jpg')}}" alt="Author" />
        ...
        <div class="col-lg-4 col-md-6 col-12">
          ...
          <div class="single-news">
            <div class="image">
              <a href="javascript:void(0)"><img class="thumb" src="{{('assets_front/images/blog/2.jpg')}}" alt="Blog" /></a>
              <div class="meta-details">
                <img class="thumb" src="{{('assets_front/images/blog/b6.jpg')}}" alt="Author" />
                <span>BY TIM NORTON</span>
              </div>
        ...
        {{-- <div class="col-lg-4 col-md-6 col-12">
          ...
          <div class="single-news">
            <div class="image">
              <a href="javascript:void(0)"><img class="thumb" src="{{('assets_front/images/blog/3.jpg')}}" alt="Blog" /></a>
              <div class="meta-details">
                <img class="thumb" src="{{('assets_front/images/blog/b6.jpg')}}" alt="Author" />
                <span>BY TIM NORTON</span>
              </div>
              ...
              <div class="row">
                <div class="col-12">
                  <div class="button text-center rounded-buttons">
                    <button type="submit" class="btn primary-btn rounded-full" id="btn-site">
                      Send Message
                    </button>
                  </div>
                </div>
          ...
          <div class="row">
            <div class="col-lg-12 col-md-6 col-12">
              ...
              <div class="footer-widget f-about">
                <div class="logo">
                  <a href="index.html">
                    <img src="{{('assets_front/images/logo.svg')}}" alt="#" class="img-fluid" />
                  </a>
                </div>
                {{-- <p class=" text-white">
  ...
  <script src="{{('assets_front/js/glightbox.min.js')}}"></script>
  <script src="{{('assets_front/js/main.js')}}"></script>
  <script src="{{('assets_front/js/tiny-slider.js')}}"></script>
 ...
 {{-- <link href="{{ asset('/public/assets_front/toastr/toastr.min.css') }}" rel="stylesheet"> --}}
 <script src="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.js" integrity="sha512-VEd+nq25CkR676O+pLBnDW09R7VQX9Mdiij052gVCp5yVH3jGtH70Ho/UUv4mJDsEdTvqRCFZg0NKGiojGnUCw==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
 <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.css" integrity="sha512-vKMx8UnXk60zUwyUnUPM3HbQo8QfmNx7+ltw8Pm5zLusl1XIfwcxo8DbWCqMGKaWeNxWA8yrx5v3SaVpMvR3CA==" crossorigin="anonymous" referrerpolicy="no-referrer" />
<script src="{{ asset('core/js/http.js') }}"></script>
<script src="{{ asset('core/js/sweetalert.min.js') }}"></script>
<script>
      $("#btn-site").on('click', function(event){
            ...
            $.post($("meta[name='BASE_URL']").attr("content") + "/api/contact-us", {
                _token: $("meta[name='csrf-token']").attr("content"),
                email: $.trim($this.find("input[name='email']").val()),
                name: $this.find("input[name='name']").val(),
                message: $this.find("textarea[name='message']").val(),
                subject: $this.find("input[name='subject']").val(),
                mobile_no: $this.find("input[name='phone']").val()
            },
...
<script src="{{asset('assets_front/js/front.js')}}"></script>
</body>
</html>