...
<script>
    ...
    $('a[data-action="destroy"]').on('click', function (e) {  
        ...
        swal({
            ...
            if (willDelete) {
                $.ajax({
                    url: $("meta[name='BASE_URL']").attr("content") + '/admin/services/' + $id,
                    type: 'DELETE',
                    data:{
...
<script>
    $(document).on('click','.edit_item_btn',function (e) {
       ...
       var id = $(this).data("id");
        $.ajax({
            url: $("meta[name='BASE_URL']").attr("content") + '/admin/services/' + id + '/edit', 
            type: "get", 
...
<script>
    $(document).on('click','.create_item_btn',function (e) {
       ...
       var id = $(this).data("id");
        $.ajax({
            url: $("meta[name='BASE_URL']").attr("content") + '/admin/services/create', 
            type: "get", 
            success: function (response) {
                if(response.code ==200){
