    ...
    $(function () {
        var table = $('#kt_datatable').DataTable({
          ...
          columns: [
              ...
              {data: 'user_name', name: 'user_name', defaultContent: "__"},
              {data: 'user_image', name: 'user_image', defaultContent: "__"},
...
<script>
    $(document).on('click','.edit_item_btn',function (e) {
       ...
       var id = $(this).data("id");
        $.ajax({
            url: $("meta[name='BASE_URL']").attr("content") + '/admin/news/' + id + '/edit', 
            type: "get", 
...
<script>
    $(document).on('click','.create_item_btn',function (e) {
       ...
       var id = $(this).data("id");
        $.ajax({
            url: $("meta[name='BASE_URL']").attr("content") + '/admin/news/create', 
            type: "get", 
            success: function (response) {
                if(response.code ==200){
