                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center p-5">
                            ...
                            <div class="d-flex flex-column">
                                <a href="{{route('services.manage')}}" class="text-dark text-hover-primary font-weight-bold font-size-h4 mb-3">{{__('Services')}}</a>
                                <div class="text-dark-75 font-size-h4" >{{$numberOFServices}}</div>
                            </div>
                            <!--end::Content-->
                        </div>
                    </div>
                ...
                <div class="card card-custom wave wave-animate-slow wave-danger mb-8 mb-lg-0">
                    <div class="card-body">
                        <div class="d-flex align-items-center p-5">
                            ...
                            <!--begin::Content-->
                            <div class="d-flex flex-column">
                                <a href="{{route('news.manage')}}" class="text-dark text-hover-primary font-weight-bold font-size-h4 mb-3">{{__('News')}}</a>
                                <div class="text-dark-75 font-size-h4" >{{$numberOFNews}}</div>
                            </div>
                            <!--end::Content-->
                        </div>
                    </div>
